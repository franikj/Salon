...
ResultSet rss = null;
rss = stt.executeQuery("select * From [dbo].[ShowServiceC]") ;
...
String data = "[Business].[INS_Desc] @Service=?,@Price=?, @Description=?";
...
if (i > 0) {
    ...
    response.sendRedirect("../Show/Sdesc.jsp");
} else {
