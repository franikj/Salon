...
<div class="col-md-6"> 
<a href="Aservice.jsp" class="btn btn-primary" style="margin: 25px 0px;">Add</a>
...
<table id="mytable" class="table" style="background-color:white;">
 ...
 try {
  Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     ...
     String query = "select * from ShowSerC";
     ResultSet rs = null;
 ...
 <a href="./Dservice.jsp?d=<%=rs.getString("ServiceID")%>" > <button type = "button" onclick="return confirm('Ви впевнені, що хочете видалити даний запис?');" class="btn btn-danger">Delete</button></a>
