...
<div class="col-md-6"> 
<a href="./Add/Acustomers.jsp" class="btn btn-primary" style="margin: 25px 0px;">Add new client</a>
</div>
<body>
<table id="mytable" class="table" style="background-color:white;">
    ...
    String query = "select * from Business.Customers";
    ResultSet rs = null;
