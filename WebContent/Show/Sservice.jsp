...
<div class="col-md-6"> 
<a href="../Add/Aservice.jsp" class="btn btn-primary" style="margin: 25px 0px;">Add</a>
<a href="../services" class="btn btn-primary" style="margin: 25px 0px;">Back</a>
</div>
...
<table id="mytable" class="table" style="background-color:white;">
	...
	try {
	    ...
	    String query = "select * from [dbo].[ShowServices]";
	    ResultSet rs = null;
	...
	<a href="../Delete/Dservice.jsp?d=<%=rs.getString("ServiceID")%>" > <button type = "button" onclick="return confirm('Ви впевнені, що хочете видалити даний запис?');" class="btn btn-danger">Delete</button></a>
