...
<div class="col-md-6"> 
<a href="../Add/ASerCat.jsp" class="btn btn-primary" style="margin: 25px 0px;">Add category</a>
...
<table id="mytable" class="table" style="background-color:white;">
	...
	<a href="../Delete/DSerCat.jsp?d=<%=rs.getString("ServiceCategoryID")%>" > <button type = "button" onclick="return confirm('Ви впевнені, що хочете видалити даний запис?');" class="btn btn-danger">Delete</button></a>
